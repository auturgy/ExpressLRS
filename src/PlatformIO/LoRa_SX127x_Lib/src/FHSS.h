...
const uint8_t FHSSsequence[255] = {17, 31, 16, 7, 8, 1, 6, 21, 29, 9, 30, 4, 13, 20, 27, 6, 2, 17, 30, 4, 3, 16, 11, 31, 11, 7, 0, 15, 9, 5, 19, 30, 17, 13, 3, 15,
...
//const uint8_t FHSSsequence[255] = {4, 2, 1, 0, 3, 1, 4, 0, 2, 0, 3, 0, 4, 3, 2, 4, 2, 1, 0, 3, 4, 2, 3, 0, 3, 2, 1, 3, 2, 4, 3, 2, 1, 3, 0, 1,
...
//                                      4, 0, 2};
const uint8_t FHSSsequence[255] = {0, 2, 0, 2, 2, 1, 2, 0, 1, 1, 0, 2, 1, 0, 1, 1, 0, 1, 1, 0, 2, 0, 2, 0, 2, 2, 2, 2, 1, 2, 2, 0, 0, 2, 0, 0, 1, 0, 0, 0, 0, 1, 2, 2, 1, 1, 2, 2, 2, 1, 1, 0, 1, 2, 2, 1, 1, 1, 2, 2, 0, 1, 2, 1, 2, 1, 2, 0, 2, 1, 0, 1, 2, 1, 0, 0, 0, 1, 2, 1, 0, 1, 0, 1, 2, 1, 1, 1, 2, 1, 0, 2, 1, 1, 0, 1, 2, 2, 0, 1, 2, 1, 2, 0, 0, 1, 2, 2, 1, 1, 1, 1, 1, 2, 0, 2, 0, 0, 1, 1, 2, 0, 0, 0, 0, 0, 1, 1, 2, 0, 1, 0, 2, 0, 0, 0, 0, 2, 0, 0, 1, 2, 1, 0, 2, 0, 2, 0, 0, 0, 0, 1, 2, 0, 2, 2, 0, 2, 2, 0, 1, 2, 0, 2, 1, 1, 2, 1, 2, 0, 0, 2, 0, 0, 2, 1, 1, 1, 1, 0, 0, 2, 2, 0, 2, 1, 1, 1, 2, 1, 1, 2, 1, 0, 0, 0, 1, 2, 0, 1, 0, 2, 2, 0, 2, 1, 2, 0, 2, 2, 0, 2, 1, 2, 0, 2, 1, 2, 1, 1, 1, 0, 0, 0, 1, 2, 1, 1, 1, 0, 2, 2, 0, 0, 2, 2, 2, 1, 2, 0, 2, 0, 2, 2, 2, 1, 1, 0, 1, 2, 2, 1, 0, 1, 2};
#endif
